...
仅文档变更只同步 `source`，不构建、切换 `current` 或重启。2026-09-14 最新发布：应用 `3a636fea6375bf539587053200f7c25df1ff5b97`（1.4.2），59 文件与本地构建 SHA-256 一致，Mini Node 22.23.1 下 51 项非原画归档测试与构建通过。旧 `7375ea8a7750e994689ab16b005262d30e34c96c` 保留回滚；本次切换立即生效，无需重启，没有数据库、上传服务或环境变量迁移。
